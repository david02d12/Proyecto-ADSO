    ...
    <container class="container-sm d-flex justify-content-center mt-5">
        <div class="card">
            <div class="card-body" style="width: 1200px;">
                ...
                <form name="roles" action="{{ url('/roles') }}" method="GET">
                    ...
                    <div class="row g-2 align-items-center">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="search" value="{{ request ('search') }}" placeholder="Buscar por codigo o roles" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                        </div>
                ...
                @if($datos->count() > 0)
                            <table class="table table-striped table-hover table-bordered ">
                                    <thead class="table-primary">
                                        <tr>
                                        <th scope="col">Codigo del Rol</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    ...
                                                    data-id="{{ $item->Codigo_Rol }}"
                                                    data-desc="{{ $item->Descripcion_Rol }}"
                                                    style="background-color:red;">
                                                    <i class="fa-solid fa-pen-to-square"></i> Editar
                                                </button>
                                                <form action="{{ route('roles.destroy', $item->Codigo_Rol) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button style="background-color:#1c1c1cff;" type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar este Rol?')">
                ...
                <div class="alert alert-info text-center mt-3">
                    ...
                    @if(request('search'))
                        No se encontraron roles con ese tipo de dato "{{ request('search') }}"
                    @else
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user"></i> Crear roles</h5>
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <div class="mb-3">
                        <label for="Codigo_Rol" class="form-label">Codigo</label>
                        <input type="number" class="form-control" id="Codigo_Rol" name="Codigo_Rol" placeholder="Digite el Codigo de la roles" required>
                    </div>
                    <div class="mb-3">
                        <label for="Descripcion_Rol" class="form-label">Descripcion del Rol</label>
                        <input type="text" class="form-control" id="Descripcion_Rol" name="Descripcion_Rol" placeholder="Digite el Nombre de la roles" required>
                    </div>
            ...
            <div class="modal fade" id="EditarModal" tabindex="-1" aria-labelledby="EditarModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="EditarModalLabel"><i class="fa-solid fa-user-pen"></i> Editar Roles</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="editForm" method="POST">
                            ...
                            @method('PUT') <!-- Muy importante -->
                             <div class="mb-3">
                                <label for="Codigo_Rol" class="form-label">Codigo</label>
                               <input type="text" class="form-control" id="editCodigo_Rol" name="Codigo_Rol"  readonly>
                    <div class="mb-3">
                        <label for="editDescripcion_Rol" class="form-label">Descripcion del Rol</label>
                        <input type="text" class="form-control" id="editDescripcion_Rol" name="Descripcion_Rol" placeholder="Digite la Nombre de la roles" required>
                    </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="background-color:#1c1c1cff;"><i class="fa-solid fa-right-from-bracket"></i> Cerrar</button>
                                <button type="submit" style="background-color:red;" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Guardar</button>
...
editarModal.addEventListener('show.bs.modal', function (event) {
    ...
    // Llenar modal
    document.getElementById('editCodigo_Rol').value = id;
    document.getElementById('editDescripcion_Rol').value = desc;
