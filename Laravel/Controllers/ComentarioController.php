...
class ComentarioController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("comentarios")->with("datos", $datos);
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('comentarios.index')->with('success','Comentario Registrado en la Plataforma');
    }
    ...
    public function update(Request $request, $Codigo_Comentario){
        ...
        $Comentario->update([
           ...
           return redirect()->route('comentarios.index')->with('success','Comentario Actualizado en la Plataforma');
