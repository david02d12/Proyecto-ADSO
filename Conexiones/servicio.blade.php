                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    ...
                                                    data-nombre="{{ $item->ID_Usuario }}"
                                                    data-fecha="{{ $item->Precio }}"
                                                    data-direccion="{{ $item->Movil_Nombre }}"
                                                    data-telefono="{{ $item->Movil_Especificacion }}"
                                                    data-correo="{{ $item->Fecha }}"
                                                    data-contraseña="{{ $item->Etapa }}">
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="ID_Usuario" name="ID_Usuario" placeholder="Digite el documento" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="Movil_Especificacion" class="form-label">Correo Electronico</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="Etapa" name="Etapa" placeholder="Digite el porcentaje de la Etapa" required>
                    </div>
            ...
            <div class="modal fade" id="EditarModal" tabindex="-1" aria-labelledby="EditarModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="editID_Usuario" name="ID_Usuario" placeholder="Digite el documento" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="editMovil_Especificacion" class="form-label">Correo Electronico</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="editEtapa" name="Etapa" placeholder="Digite el porcentaje de la Etapa" required>
                    </div>
                            <div class="modal-footer">
